...
namespace ApiCommon.API.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string toEmail, string subject, string body, bool isBodyHtml = true)
        {
            ...
            mail.From = new MailAddress(_emailServiceSettings.EmailAddress);
            mail.To.Add(toEmail);
            ...
            using var smtp = new SmtpClient(_emailServiceSettings.Host, _emailServiceSettings.Port);

            smtp.Credentials = new NetworkCredential(_emailServiceSettings.EmailAddress, _emailServiceSettings.Password);
            smtp.EnableSsl = true;
